...
public class Stage2 extends JPanel {
	...
	public Stage2(MainFrame mainFrame){
		...
		//배경음악 & 총알 발사음
		bgm.playBgm(new File("stage2.wav"),1,true);
	        	...
	        	public void keyPressed(KeyEvent e) {
	        		...
	        		case KeyEvent.VK_SPACE: 
	        			...
	        			if(bulletThread2==null || !bulletThread2.isAlive()){
    	                    ...
    	                    bulletThread2 = new BulletThread2(panel); //총알을 움직이는 스레드 생성
    	                    bulletThread2.start();    	                       	                    
	        			}break;
	        		  }
	        		}
    ...
    public void startGame(){ 	                
        ...
        ImageIcon remainTImg = new ImageIcon("BlueMonster.png");  //이미지 설정
